...
@Component({
  selector: 'app-agregar-usuario2',
  templateUrl: './agregar-usuario2.component.html',
  styleUrls: ['./agregar-usuario2.component.css']
})
export class AgregarUsuarioComponent2 implements OnInit {
